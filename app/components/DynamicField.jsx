...
const DynamicField = () => {
  ...
  return (
      <div className="py-6">
                  ...
                  <div className="col-span-4">
                     ...
                     <input type="text"
                      ...
                      className="py-2 px-4  rounded-lg focus:border-2 border border-gray-300 w-full focus:border-[#06847B] outline-none focus:placeholder:text-[#06847B] "
                        onChange={(e)=>handleFieldChange(index,e.target.value,"key")}
                      />
                  </div>
        ...
        <input type="text"     
        value={field.value}
         onChange={(e)=>handleFieldChange(index,e.target.value,"value")}
        disabled={field.key == ""}  className="py-2 px-4 disabled:bg-[#f4f4f4] rounded-lg focus:border-2 border border-gray-300 w-full focus:border-[#06847B] outline-none focus:placeholder:text-[#06847B] "/>
            ...
            className="w-6 h-6" focusable="false" viewBox="0 0 24 24" aria-hidden="true"><path d="M6 19c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7H6v12zM19 4h-3.5l-1-1h-5l-1 1H5v2h14V4z"></path></svg>
            </div>
